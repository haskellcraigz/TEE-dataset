...
wave_local_nuts2 <- read.csv("~/TEEDataset/data/02_metrics/wave_local_nuts2.csv")
wave_local_nuts3 <- read.csv("~/TEEDataset/data/02_metrics/wave_local_nuts3.csv")

wave_global_nuts2 <- read.csv("~/TEEDataset/data/02_metrics/wave_global_nuts2.csv")
wave_global_nuts3 <- read.csv("~/TEEDataset/data/02_metrics/wave_global_nuts3.csv")
...
write.csv(wave_nuts2, "~/TEEDataset/data/03_fulldatasets/teewave_nuts2.csv")
...
write.csv(wave_nuts3, "~/TEEDataset/data/03_fulldatasets/teewave_nuts3.csv")
